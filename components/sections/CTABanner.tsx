...
/**
 * Closing CTA — the boldest warm moment: an orange→gold "golden hour" gradient
 * (the one sanctioned place gold supports the orange accent). White copy, a solid
 * white primary button and a ghost call button. The page's warm anchor before
 * the navy footer.
 */
export default function CTABanner() {
  return (
    <section className="bg-gradient-to-br from-orange to-gold py-20 text-white sm:py-28">
